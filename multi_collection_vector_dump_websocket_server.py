...
splits = get_doc_spliter(chnk_sz=200, chnk_olp=50).split_documents(
    get_docs(file_path='data/2024-12-01/2024-12-01_articles.csv'))
...
# my_vector_db.insert_DB(splited_docs=splits, collection_name="test")
...
async def dump_into_vector_DB(news_archive_date,websocket):
    ...
    chunk_splits = split_list(splits[0:101], 10)
    ...
    #my_vector_db._collection.count()
